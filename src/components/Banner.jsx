    ...
    <ParallaxBanner
      ...
      <div className="z-10 bg-gray-100/50 shadow-xl">
        <div className="p-4 backdrop-blur">
          <h1
            className={classNames('text-gray-800 md:text-center font-extralight tracking-tight', {
              'text-6xl md:text-9xl': full,
              'text-5xl md:text-8xl': !full,
            })}>
            {title}
          </h1>
          {subtitle && <span className="mt-2 block text-gray-800 text-xl md:text-2xl md:text-center">{subtitle}</span>}
        </div>
      </div>
    </ParallaxBanner>
  );
